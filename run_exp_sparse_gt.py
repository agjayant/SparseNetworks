...
## Vary sparse_gt
exp_sparse_gt = [0.90, 0.75, 0.50, 0.25, 0.10]

logFile = open(args.log,'w')

for sparse_gt in exp_sparse_gt:
    ...
    for trial in range(num_trials):
        ...
        print "Experiment Starting for sparse_gt = ",sparse_gt, " trial: ", trial
    ...
    logFile.write(str(sparse_gt)+' '+str(avg_recov)+' '+str(std_recov) + ' '+str(avg_recov_o)+' '+str(std_recov_o)+' ' )
