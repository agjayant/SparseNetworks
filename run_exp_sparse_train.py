...
## Vary sparse_train
exp_sparse_train = [0.90, 0.75, 0.50, 0.25, 0.10]

logFile = open(args.log,'w')

for sparse_train in exp_sparse_train:
    ...
    for trial in range(num_trials):
        ...
        print "Experiment Starting for sparse_train = ",sparse_train, " trial: ", trial
    ...
    logFile.write(str(sparse_train)+' '+str(avg_recov)+' '+str(std_recov) + ' '+str(avg_recov_o)+' '+str(std_recov_o)+' ' )
